...
CONFIG = {
    ...
    "OUTPUT_EXCEL_PATH": "Study3_gpt3.xlsx",
    "SHEET_NAME": "Sheet1",
...
def rate_chat_with_gpt(client, chat_content: str, prolific_id: str):
    """Call GPT model to get ratings, return None on failure"""
...
"""},
            ...
            wait_time = 20 if "rate limit" in str(e).lower() else 5
...
def clean_response_text(text):
    ...
    # Remove common JSON wrapping markers
...
def process_row(client, row, save_dir):
    ...
    response = rate_chat_with_gpt(client, content, prolific_id)
...
def process_chat_ratings():
    ...
    save_dir = "/Users/huangxinjie/Desktop/personality/save_gpt"
    ...
    total_rows = len(df)
    print(f"Starting to process {total_rows} records, parallel workers: {CONFIG['PARALLEL_WORKERS']}")
